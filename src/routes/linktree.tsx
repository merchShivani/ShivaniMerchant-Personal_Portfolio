    ...
    <main className="relative min-h-dvh overflow-hidden bg-[oklch(0.25_0.07_318)] text-paper">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100dvh-2.6rem)] w-full max-w-md flex-col justify-center px-5 py-5 sm:px-8">
        ...
        <nav aria-label="My links" className="mt-4 space-y-2">
          {tiles.map((tile, i) => {
            const inner = (
              <span className={`flex min-h-[56px] w-full items-center gap-3 rounded-2xl px-4 py-3 text-left text-navy transition-transform hover:-translate-y-0.5 active:translate-y-0 sm:px-5 md:min-h-[56px] md:gap-4 ${tile.primary ? "bg-pink-hot shadow-[0_0_44px_-12px_rgba(236,72,153,0.55)]" : "bg-paper/95 shadow-[0_14px_34px_-24px_oklch(1_0_0)]"}`}>
